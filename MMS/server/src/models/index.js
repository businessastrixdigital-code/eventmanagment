...
const dbWrapper = {
  ...
  WhatsAppConnection: new ModelWrapper('WhatsAppConnection', schema.whatsappConnections),
  CommunicationLog: new ModelWrapper('CommunicationLog', schema.communicationLogs),
